    ...
    <div class="relative z-10 flex items-center justify-center min-h-screen p-4">
      <div class="login-card">
        ...
        <div class="card-header">
          ...
          <p class="card-subtitle">Sign in to your Secure Chat account</p>
        </div>
...
const handleLogin = async () => {
  ...
  try {
    ...
    if (result && result.success) {
      ...
      showNotification('Error', result?.message || 'Invalid username or password', 'error')
    }
  } catch (error) {
...
/* Login card */
.login-card {
  @apply w-full max-w-md bg-white/90 dark:bg-dark-100/90 backdrop-blur-xl rounded-3xl p-8 border border-gray-200/50 dark:border-dark-200/50;
...
.header-icon {
  @apply w-16 h-16 bg-blue-500 text-white rounded-3xl flex items-center justify-center mx-auto mb-4;
...
.form-input {
  @apply w-full pl-10 pr-12 py-4 bg-gray-50/80 dark:bg-dark-200/80 border border-gray-200/50 dark:border-dark-300/50 rounded-2xl text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500/50 transition-all duration-200;
}
...
/* Submit button */
.submit-btn {
  @apply w-full flex items-center justify-center space-x-2 px-6 py-4 bg-blue-500 hover:bg-blue-600 disabled:bg-gray-300 dark:disabled:bg-dark-300 text-white disabled:text-gray-500 rounded-2xl font-medium transition-all duration-200 transform hover:scale-105 active:scale-95 disabled:transform-none disabled:cursor-not-allowed;
  box-shadow: var(--shadow-soft);
}
...
.register-link {
  @apply text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-colors duration-200;
}
